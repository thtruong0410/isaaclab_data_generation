...
BOX_INIT_POS = (0.92, 0.12, 0.0203)
BOX_X_RANGE = (0.82, 1.02)
BOX_Y_RANGE = (-0.18, 0.42)
BOX_YAW_RANGE = (-0.40, 0.40)
ARM_JOINT_RESET_STD = 0.02
FRANKA_ARM_DEFAULT_POSE = [-0.38, -0.3194, -0.1107, -2.5148, 0.0044, 2.3775, 0.6952, 0.0, 0.0]
